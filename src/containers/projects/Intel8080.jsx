...
class Intel8080 extends React.Component {
  ...
  render() {
    return (
      <div>
        <Helmet>
          <title>Jake Kinsella - Project: Intel 8080 Emulator</title>
          <meta
            name="description"
            content="An emulator for the Intel 8080, an 8-bit CPU released in 1974. It emulates all the
        ...
        <FadeIn>
          ...
          <Content>
            <Text type="body1">
              <ProjectImage
                src={`${IMAGES_URL}projects/intel8080_code.png`}
                alt="Intel 8080 Code"
              />
              ...
              <p>
                ...
                here). This project inspired me to have another go at writing an emulator with a
                more practical and well defined CPU.
              </p>

              <p>
                I the idea of writing an emulator for the 8080 popped into my head while I was
                reading Code: The Hidden Language of Computer Hardware and Software, in which the
                author describes the inner workings of the 8080. The elegance of its insides
                inspired me to pull up the Intel manual and read more about the opcodes and
                registers. Through this, I decided that I wanted to give emulating this CPU a shot.
              </p>

              <p>
                So after reading through the entire manual, I felt confident enough to start writing
                the code, and quickly settled on C as my language of choice so that I could gain
                more experience in such a fundamental language.
              </p>

              <p>
                I started off by writing the main loop and basic registers and immediately decided
                that for each module and opcode that I wrote, I would write multiple unit tests.
                This was a huge lesson that I learned from my last attempt at writing an emulator
                which quickly got out of hand with bugs and unreadable code.
              </p>
