...
class CandidateXYZ extends React.Component {
  ...
  render() {
    return (
      <div>
        <Helmet>
          <title>Jake Kinsella - Project: candidateXYZ</title>
          <meta
            name="description"
            content="CandidateXYZ is a web app created to give everyone the opportunity to run for office
                regardless of prior experience, connections, and money. The application helps
                candidates set up a campaign to run for office by forming a committee allowing them
                to raise money, and streamlining the complex job of tracking a campaign’s expenses."
          />
        </Helmet>
          ...
          <Content>
            <Text type="body1">
              ...
              <p>
                ...
                world where anyone could decide to run for office creating a wealth of new
                candidates who cut across our current political divisions. My initial product idea
                was to build a product like Wordpress or Squarespace but tailored for the needs of
                small political campaigns. With this in mind I began building a generic candidate’s
                website that would be easily modifiable by me.
              </p>

              <p>
                I sold this initial product to a local party committee in my area after meeting with
                the chairwoman. With this done, I quickly moved on to making the website
              ...
              <p>
                With the new understanding of the market I was in by building this product, I
                realized my product simply didn’t fill a deep consumer need. Candidates weren’t
                being held back for running for office because there was a lot of paperwork, nor
                were they being held back because they couldn’t get people to run their campaign’s
                for them. They were be held back due to social and commitment reasons. Simply put,
                running for office is exhausting, and my product didn’t address this fatal issue.
              </p>
              ...
              <p>
                ...
                process of taking a field I wasn’t familiar with and rapidly learning about it
                through building a product taught me a lot. My biggest downfall was that I laid low
                and built my product for too long ignoring the valuable insights that would have
                come from real conversations to my potential customers.
              </p>
