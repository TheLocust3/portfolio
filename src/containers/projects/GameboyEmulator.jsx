        ...
        <Content>
          <Text type="body1">
            ...
            <p>
              ...
              truly large project). For school, I had a graphing calculator (the Ti-NSpire CX CAS)
              which had a full color display and keyboard, which generally was completely overkill
              but for high schoolers, was a ton of fun. With this calculator, you could run certain
              exploits that would allow it to run binary programs rather than simply Lua scripts.
            ...
            <p>
              ...
              wait long times as maintainers attempted to break into the system again. This made me
              wonder, why do we even need to run a compiled emulator, why can I write my own in Lua
              and skip the exploit process?
            </p>

            <p>
              This question inspired me to learn the inner workings of the Gameboy and learn about
              emulator and CPU architecture. Over the next months I read everything I could on the
              subject until I felt that I was ready to write my own emulator. This process started
              by me writing a simple Ruby script to convert Gameboy machine code to Assembly so that
              I could figure out what was actually on a ROM.
            </p>
            ...
            <p>
              ...
              times. In the end, while it never completely worked I learned so many hard skills like
              how to write an emulator, assembly, and low level computer architecture. I also
              learned many soft skills like how the organize large projects, the importance of fully
              testing code, and how to tackle a large project.
            </p>
